...
### data with locations
data_all = pd.read_feather("data/norddeutschland/"+dataname+"_tidy.feather")
data_all = data_all.drop(["index","ID","Station","DD_QB","FF_QB","FF_MAX_MW_QB","FF_WS_QB","DD_WS_QB"], axis=1)
print(list(data_all.columns))


### READ AND CREATE MWE
dt = pd.read_csv("data/dbtestdata.csv")
